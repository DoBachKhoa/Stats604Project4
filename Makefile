...
$(DATA_METERED_PROCESSED_DIR) : $(VENV_DIR)
...
$(DATA_WEATHER_HOURLY_PROCESSED_DIR) : $(VENV_DIR) $(DATA_WEATHER_HOURLY_RAW_DIR)
...
$(PCA_ENCODING_PARAMS_DIR) : $(VENV_DIR) $(DATA_WEATHER_HOURLY_PROCESSED_DIR)
